jQuery(function() {
    ...
    a.fn.ace_tree = function(d) {
        ...
        this.each(function() {
            var e = a(this);
            e.html('<div class = "tree-folder" style="display:none;">				<div class="tree-folder-header">					<i class="' + c["close-icon"] + '"></i>			<span class="tree-item"> <i class="' + c["unselected-icon"] + '"></i>  <div class="tree-folder-name"></div>	</span>			</div>				<div class="tree-folder-content"></div>				<div class="tree-loader" style="display:none"></div>			</div>			<div class="tree-item tree-item-item" style="display:none;">				' + (c["unselected-icon"] == null ? "": '<i class="' + c["unselected-icon"] + '"></i>') + '				<div class="tree-item-name"></div>			</div>');
