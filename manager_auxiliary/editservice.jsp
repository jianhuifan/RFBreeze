...
<%@page import="com.weiguang.shell.ServiceDescTools"%>
...
<title>Service编辑器</title>
	...
	<link href="../page/manager/assets/css/bootstrap-responsive.min.css" rel="stylesheet" />
	<link rel="stylesheet" href="../page/manager/assets/css/font-awesome.min.css" />

	<!--[if IE 7]>
	  <link rel="stylesheet" href="../page/manager/assets/css/font-awesome-ie7.min.css" />
	<![endif]-->

	<!--page specific plugin styles-->
	<link rel="stylesheet" href="../page/manager/assets/css/jquery-ui-1.10.3.custom.min.css" />
	<link rel="stylesheet" href="../page/manager/assets/css/chosen.css" />

	<!--fonts-->
	<link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Open+Sans:400,300" />

	<!--ace styles-->
	<link rel="stylesheet" href="../page/manager/assets/css/ace.min.css" />
	<link rel="stylesheet" href="../page/manager/assets/css/ace-responsive.min.css" />
	<link rel="stylesheet" href="../page/manager/assets/css/ace-skins.min.css" />
...
<script>
	...
	seajs.config({});
	seajs.use([ '<%=this.getServletContext().getContextPath() %>/manager_auxiliary/service/service'], function(a) {
