...
<%@page import="com.weiguang.framework.init.service.Log4jInit"%>
...
<%
	...
	String dburl = "jdbc:mysql://localhost:3306/"+dbName+"?relaxAutoCommit=true&zeroDateTimeBehavior=convertToNull&characterEncoding=utf8";
